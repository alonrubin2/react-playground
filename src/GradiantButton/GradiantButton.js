...
class GradiantButton extends Component {
    ...
    render() {
        return (
            ...
            style={{background: `linear-gradient(to bottom right, ${this.props.color1}, ${this.props.color2}`, height: this.props.height+'px', width: this.props.height*3.2+'px', display: "inline-block", boxShadow: '10px 10px #888888'}}>
